...
$('.changeBackgroundColor').on('click', function(){
	...
	$('.table').css('border','1px solid #2f374c !importent')
...
function customCheckColor(){
	...
	if (logoHeader !== "white") {
		$('.logo-header .navbar-brand').attr('src', '../js/lib/assets/img/logo.svg');
	} else {
	    $('.logo-header .navbar-brand').attr('src', '../js/lib/assets/img/logo2.svg');
	}
}
